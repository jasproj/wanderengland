...
const EV = 'scripts/evidence/s49-weng-release';
...
const inA = t => t.priceSource === 's47-weng-wholeparty' && /HELD/.test(t.priceBasis || '') && !String(t.priceEnrichmentAt).startsWith('2026-08-24');
